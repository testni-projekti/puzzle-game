...
export default function RegisterPage() {
  ...
  const handleSSORegister = (provider: string) => {
    console.log(`SSO registracija z ${provider}`);
    // Tu bi implementirali SSO registracijo
  };
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600 mt-2">Ustvarite nov račun za COBISS Puzzle</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              >
                {isLoading ? 'Registriram...' : 'Registracija'}
              </Button>
            </form>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">ali se registriraj z</span>
              </div>
            </div>
